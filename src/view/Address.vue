<template>
    <div>
          ...
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              ...
              <div class="shipping-addr-more">
                <!--添加  class为open,图标就改变了-->
                <a class="addr-more-btn up-down-btn" href="javascript:;" @click="getMore" v-bind:class="{'open':limit==3}">
                  more
                  <i class="i-up-down">
            ...
            <div class="next-btn-wrap">
              ...
              <router-link class="btn btn--m btn--red" v-bind:to="{path:'orderConfim',query:{'addressId':selectAddressId}}">Next</router-link>
            </div>
          </div>
        </div>
      </div>
      ...
      <Modal v-bind:mdShow="isAdd" class="addAddress">
        ...
        <input type="text" placeholder="请输入你的地址" v-model="address">
        <input type="text" placeholder="请输入你的电话" v-model="tel">
