<template>
  <header class="header">
   <!-- 遮罩层 -->
    <div class="mask_layer" v-show="blackShow"></div>
    ...
    <!-- 登录 -->
    <div class="md-modal modal-msg md-modal-transition " v-bind:class="{'md-show':loginFlag}"><!--md-show控制登陆框的显示影藏-->
      <!-- class=md-show控制登陆框的显示隐藏 -->
